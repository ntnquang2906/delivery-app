...
export default function BrowseItem({ params }) {
    let filteredRestaurant = restaurant_list.filter((restaurant) => {
        return restaurant._id = params._id
    })
    ...
    const restaurantInfo = (
        <Box className={styles.container}>
            ...
            <Heading className={styles.restaurant_name} as="h1" size="xl">{filteredRestaurant.name}</Heading>
